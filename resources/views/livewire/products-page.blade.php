            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range" wire:model.live='price_range'
                                ...
                                max="500000" value="200000" step="1000">
                ...
                <div class="w-full px-3 lg:w-3/4">
                    ...
                    <div class="flex flex-wrap items-center ">
                        ...
                        {{-- To make the products page dyunamic with backend --}}
                        ...
                        @foreach ($products as $product)
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
                                <div class="border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm">
                                    <!-- Fixed Image Box -->
                                    <div
                                        class="relative w-full h-64 bg-gray-100 overflow-hidden flex items-center justify-center">
